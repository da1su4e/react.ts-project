                            ...
                            <div className="bg-white p-10 rounded-[32px] shadow-lg relative">
                                ...
                                <form action="" className="mt-10 flex flex-col gap-8">
                                    <div className="flex flex-col gap-2.5">
                                        ...
                                        <input type="email" className="pl-6 py-3.5 rounded-xl outline-none bg-[#F1F4F8] w-[460px]" placeholder="Enter your e-mail" required />
                                    </div>
                                    <div className="flex flex-col gap-2.5">
                                ...
                                <p className="text-[#8F8F8F] mt-8">Protected by reCAPTCHA and subject to the Google <span className="text-[#1749B3]">Privacy <br />Policy</span> and <span className="text-[#171717]">Terms of Service</span>.</p>
                                <button 
                                    onClick={() => setIsModalOpen(false)} 
